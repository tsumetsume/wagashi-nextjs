...
CREATE TABLE `products` (
    ...
    `description` VARCHAR(191) NULL,
    `allergyInfo` VARCHAR(191) NULL,
    `calories` INTEGER NULL,
    `size` VARCHAR(191) NOT NULL,
    `beforeImagePath` VARCHAR(191) NULL,
    `afterImagePath` VARCHAR(191) NULL,
    `enlargedImagePath` VARCHAR(191) NULL,
    `ingredients` VARCHAR(191) NULL,
    `nutritionInfo` VARCHAR(191) NULL,
    `shelfLife` VARCHAR(191) NULL,
    `storageMethod` VARCHAR(191) NULL,
